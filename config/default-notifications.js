...
let default_notifications = async function(campaign_id) {
    ...
    {name:"invitation",
        ...
        message:`Hello there, \r\nYou have been invited to use the [[_company_name]] Weferral System. From <a href='${process.env.FRONTEND_URL}'>here</a> you can manage your campaigns, and see other campaign options. Please click the link to begin user <a href='[[url]]'>registration</a>.`,
    ...
    {name:"registration_user",
        ...
        campaign_id: campaign_id,
        message:`Your registration has been completed! You can now access your account at <a href='${process.env.FRONTEND_URL}'>here</a>. Thank you for choosing [[_company_name]].`,
    ...
    {name:"user_suspension",
        ...
        campaign_id: campaign_id,
        message:`Your Weferral account has been suspended. Please contact your service provider and check the state of your <a href='${process.env.FRONTEND_URL}/profile'>account</a>.`,
    ...
    {name:"participant_approval",
        ...
        campaign_id: campaign_id,
        message:`Your Weferral account has been approved. You can now login to your <a href='${process.env.FRONTEND_URL}/profile'>account</a> and start sharing your referral links.`,
