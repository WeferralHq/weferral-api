...
let getNotificationSagas = (eventName,id) => async (dataObj, userToNotify) => {
    ...
    return new Promise(function (resolve, reject) {
        NotificationTemplate.findFilter({'campaign_id': id, 'event_name': eventName}, function (template) {
...
module.exports = function notification(event_name, id, modelObj, userToNotify) {
